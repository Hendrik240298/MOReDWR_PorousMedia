# -*- coding: utf-8 -*-
"""FEniCS_3D_footing_problem_backward_Euler.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1awD-dO6YdTNFXVx6qouvKQ8-5uLYkChX

# Solving the 3D footing problem benchmark for porous media in FEniCS using a backward Euler time discretization
"""
...
compression = CompiledSubDomain("near(x[2], 0.) && x[0] >= -16. && x[0] <= 16. && x[1] >= -16. && x[1] <= 16. && on_boundary")
dirichlet = CompiledSubDomain("near(x[2], 64.) && on_boundary")
neumann = CompiledSubDomain("( near(x[0], -32.) || near(x[0], 32.) || near(x[1], -32.) || near(x[1], 32.) || (near(x[2], 0.) && (x[0] < -16. || x[0] > 16. || x[1] < -16. || x[1] > 16.) ) ) && on_boundary")
